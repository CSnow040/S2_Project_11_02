...
// This adds a date to every single scheduled day
var thisDate = new Date("October 12, 2018");
// This makes sure that it is attached to a specific locale specifiying the date
var dateString = thisDate.toLocaleDateString();
// This makes the h2 in the HTML match with the date at the top as well as the specific date for that day 
var dateHTML = "<h2>" + dateString + "</h2>";
// This variable with the specification of thisdate with the method of getDay tells the variable to retrieve the day's specfic day
var thisDay = thisDate.getDay();
// This does the same thing with the variabe however it calls upon the events that wil be placed underneath that day
var eventHTML = getEvent(thisDay);
// This grabs all of the content for each case date and case content
